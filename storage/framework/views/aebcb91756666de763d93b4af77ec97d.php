    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('stripe.charge',['product'=>$product->id])); ?>" id="payment-form">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\deepak\resources\views/products/show.blade.php ENDPATH**/ ?>